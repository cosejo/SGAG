...
namespace ITCR.SGAG.Base
{
	...
	public class cSGGIIMPLEMENTOBase : cBDInteraccionBase
	{
		#region Declaraciones de miembros de la clase
			private SqlInt32		_fK_IDDEPORTE, _fK_IDDEPORTEOld, _cAN_ENINVENTARIO, _cAN_DISPONIBLE, _iD_IMPLEMENTO, _fK_IDTIPOIMPLEMENTO, _fK_IDTIPOIMPLEMENTOOld;
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				cmdAEjecutar.Parameters.Add(new SqlParameter("@sDSC_IMPLEMENTO", SqlDbType.VarChar, 30, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, _dSC_IMPLEMENTO));
				cmdAEjecutar.Parameters.Add(new SqlParameter("@iFK_IDDEPORTE", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, _fK_IDDEPORTE));
				cmdAEjecutar.Parameters.Add(new SqlParameter("@iCAN_ENINVENTARIO", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, _cAN_ENINVENTARIO));
				cmdAEjecutar.Parameters.Add(new SqlParameter("@iCAN_DISPONIBLE", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, _cAN_DISPONIBLE));
		...
		/// <UL>
		///		 <LI>FK_IDDEPORTE. May be SqlInt32.Null</LI>
		///		 <LI>FK_IDDEPORTEOld. May be SqlInt32.Null</LI>
		/// </UL>
		/// Propiedades actualizadas luego de una llamada exitosa a este método: 
		/// <UL>
		///		 <LI>CodError</LI>
		...
		{
			SqlCommand	cmdAEjecutar = new SqlCommand();
			cmdAEjecutar.CommandText = "dbo.[pr_SGGIIMPLEMENTO_ActualizarTodos_Con_FK_IDDEPORTE_FK]";
			cmdAEjecutar.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				cmdAEjecutar.Parameters.Add(new SqlParameter("@iFK_IDDEPORTEOld", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, _fK_IDDEPORTEOld));
				cmdAEjecutar.Parameters.Add(new SqlParameter("@iCodError", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _codError));
				...
				{
					// Genera un error.
					throw new Exception("Procedimiento almacenado 'pr_SGGIIMPLEMENTO_ActualizarTodos_Con_FK_IDDEPORTE_FK' reportó el error Código: " + _codError);
				}
			...
			{
				// Ocurrió un error. le hace Bubble a quien llama y encapsula el objeto Exception
				throw new Exception("cSGGIIMPLEMENTOBase::ActualizarTodos_Con_FK_IDDEPORTE_FK::Ocurrió un error." + ex.Message, ex);
			}
			finally
			{
				if(_conexionBDEsCreadaLocal)
		...
		{
			SqlCommand	cmdAEjecutar = new SqlCommand();
			cmdAEjecutar.CommandText = "dbo.[pr_SGGIIMPLEMENTO_EliminarTodo_Con_FK_IDDEPORTE_FK]";
			cmdAEjecutar.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Genera un error.
					throw new Exception("Procedimiento almacenado 'pr_SGGIIMPLEMENTO_EliminarTodo_Con_FK_IDDEPORTE_FK' reportó el error Código: " + _codError);
				}
			...
			{
				// Ocurrió un error. le hace Bubble a quien llama y encapsula el objeto Exception
				throw new Exception("cSGGIIMPLEMENTOBase::EliminarTodo_Con_FK_IDDEPORTE_FK::Ocurrió un error." + ex.Message, ex);
			}
			finally
			{
				if(_conexionBDEsCreadaLocal)
		...
		public override DataTable SeleccionarUno()
		{
			...
			try
			{
				...
				if(toReturn.Rows.Count > 0)
				{
					...
					_fK_IDDEPORTE = toReturn.Rows[0]["FK_IDDEPORTE"] == System.DBNull.Value ? SqlInt32.Null : (Int32)toReturn.Rows[0]["FK_IDDEPORTE"];
					_cAN_ENINVENTARIO = toReturn.Rows[0]["CAN_ENINVENTARIO"] == System.DBNull.Value ? SqlInt32.Null : (Int32)toReturn.Rows[0]["CAN_ENINVENTARIO"];
					_cAN_DISPONIBLE = toReturn.Rows[0]["CAN_DISPONIBLE"] == System.DBNull.Value ? SqlInt32.Null : (Int32)toReturn.Rows[0]["CAN_DISPONIBLE"];
				}
				return toReturn;
			}
			catch (Exception ex)
		...
		{
			SqlCommand	cmdAEjecutar = new SqlCommand();
			cmdAEjecutar.CommandText = "dbo.[pr_SGGIIMPLEMENTO_SeleccionarTodos_Con_FK_IDDEPORTE_FK]";
			cmdAEjecutar.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("SGGIIMPLEMENTO");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdAEjecutar);
			...
			try
			{
				...
				{
					// Genera un error.
					throw new Exception("Procedimiento Almacenado 'pr_SGGIIMPLEMENTO_SeleccionarTodos_Con_FK_IDDEPORTE_FK' reportó el error Código: " + _codError);
				}
			...
			{
				// Ocurrió un error. Le hace Bubble a quien llama y encapsula el objeto Exception
				throw new Exception("cSGGIIMPLEMENTOBase::SeleccionarTodos_Con_FK_IDDEPORTE_FK::Ocurrió un error." + ex.Message, ex);
			}
			finally
			{
				if(_conexionBDEsCreadaLocal)
		...
		public SqlInt32 CAN_ENINVENTARIO
		{
			get
			{
				return _cAN_ENINVENTARIO;
			}
			set
			{
				_cAN_ENINVENTARIO = value;
			}
		}


		public SqlInt32 CAN_DISPONIBLE
		{
			get
			{
				return _cAN_DISPONIBLE;
			}
			set
			{
				_cAN_DISPONIBLE = value;
			}
		}
		#endregion
	}
