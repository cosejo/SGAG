...
namespace ITCR.SGAG.Base
{
	...
	public class cSGPRPRESTAMOBase : cBDInteraccionBase
	{
        ...
        {
            SqlCommand cmdAEjecutar = new SqlCommand();
            cmdAEjecutar.CommandText = "dbo.[pr_SGPRPRESTAMO_ObtenerReporte]";
            cmdAEjecutar.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("SGPRPRESTAMO");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdAEjecutar);
            ...
            try
            {
                cmdAEjecutar.Parameters.Add(new SqlParameter("@daFEC_PRESTAMO_INI", SqlDbType.DateTime, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, dateTimeInicio));
                cmdAEjecutar.Parameters.Add(new SqlParameter("@daFEC_PRESTAMO_FIN", SqlDbType.DateTime, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, dateTimeFinal));
                cmdAEjecutar.Parameters.Add(new SqlParameter("@iCodError", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _codError));
                ...
                {
                    // Genera un error.
                    throw new Exception("Procedimiento Almacenado 'pr_SGPRPRESTAMO_ObtenerReporte' reportó el error Código: " + _codError);
                }
